...
public class URLTestViewModel {
    ...
    private final com.example.transformapp.URLTestModel urlTestModel = new com.example.transformapp.URLTestModel();

    private final com.example.transformapp.Notifications notifications = new com.example.transformapp.Notifications();

    public URLTestViewModel() {
        notifications.subscribe(com.example.transformapp.Notifications.EVENT_MODEL_UPDATE,
                this,
